      ...
      <li data-v-ed816bee="" className="CheckList__wrapper">
        <div data-v-ed816bee="" className="CheckList__item">
          ...
          <span data-v-ed816bee="" className="text-sm font-comfort font-light">
            Book your event with our qualified massage therapists.
            <br />
            We are offering <span className="font-extrabold">1 day free trial</span> at your office premises.
          </span>
        </div>
      </li>
      <li data-v-ed816bee="" className="CheckList__wrapper">
        <div data-v-ed816bee="" className="CheckList__item">
          ...
          <span data-v-ed816bee="" className="text-sm font-comfort font-light">
            your employees reserve <span className="font-extrabold">15 minute sessions</span> via our <span className="font-extrabold">online booking system</span>. 15 minute sessions often work best but we can adjust as needed.
          </span>
        </div>
      </li>
      <li data-v-ed816bee="" className="CheckList__wrapper">
